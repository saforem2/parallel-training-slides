...
::: {layout="[60,-5, 35]" layout-valign="center" style="display: flex; align-items:flex-end;"}

::: {.col1}

[**[AI for Science Training Series](https://github.com/argonne-lcf/llm-workshop)**[^1]]{.dim-text}  
[Argonne National Laboratory]{.dim-text}  
<br>

[[{{< bi person-badge >}}Sam Foreman](https://samforeman.me)]{style="font-weight: 600;"}  
[\[2024-03-12\]]{.dim-text style="font-size: 0.8em;"}  
...
- [{{< iconify line-md home-md-twotone-alt >}}`argonne-lcf/`](https://github.com/argonne-lcf/)
  - [{{< iconify line-md github-loop >}}`ai-science-training-series/`](https://github.com/argonne-lcf/ai-science-training-series)
    - [{{< iconify line-md document >}}`06_parallel_training_methods/`](https://github.com/argonne-lcf/ai-science-training-series/blob/main/06_parallel_training_methods/README.md)

- [{{< iconify line-md person >}}`saforem2/`](https://github.com/saforem2)
  ...
  <!-- - [{{< iconify line-md github-loop >}} `llm-workshop-talk`] -->
    <!-- - [\[{{< bi easel >}} slides\]](https://github.com/saforem2/llm-workshop-talk)  -->
...
[![](https://cdn-lfs.huggingface.co/datasets/huggingface/documentation-images/315020969c2ee0750b0d3b3815ee7e4ab321c4723f81de977ab6320f28715485?response-content-disposition=inline%3B+filename*%3DUTF-8%27%27parallelism-deepspeed-3d.png%3B+filename%3D%22parallelism-deepspeed-3d.png%22%3B&response-content-type=image%2Fpng&Expires=1710014172&Policy=_&Signature=LfXYJ8on2VB643vlUqFHhKR4E0gp1D8lk8kZXZuNBJGToBcCOOdsSAHrl5DLTO6g0PkYzGOoRfN2bDlHQ7rxBEo%7E%7EQ8VJutDH3BP6ShhZ2nSva4MFtdMefLfwMRzjFZCEB3t4H4Q0-Hb5Z6Dxv4KvkUNhEk1ee6xW3Wcfz5Xo9TJ-wC-J7oVm%7ErPQdlphL8FMBI67W1HfgZQCTGu6iIdK6Hv0XOXB4T%7E89PuVVn0Wlf6A7QqaMVcll51DzdA-IoG%7E2Q5I-5tjyVH%7EhX3zsIbw7%7EZbxsftgajEbJQcHUrqF2ZIRq9HA7wlD3GQDyhG8gXNNVOPqrWLj4sTPs9IuBm%7EQ__&Key-Pair-Id=KVTP0A1DKRTAX)]{.stretch}

[Image from [🤗 Transformers / Efficient Training on Multiple GPUs](https://huggingface.co/docs/transformers/en/perf_train_gpu_many)]{.dim-text}
:::
...
> 34-month doubling time[^moore], or \[**300,000**x\].
...
\[**300,000**x since 2012\] vs \[7x for Moore's Law\]
...
**SLOW** !!, model size determined by GPU memory
:::
...
- Each worker has identical copy of model[^1]
